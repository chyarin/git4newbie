...
Этот [модуль](мод.рф "Курс по Git состоит из учебных модулей. Каждый из них поделён на темы, а темы — на уроки.") — для тех, кто только начинает знакомиться с Git. Мы расскажем:
